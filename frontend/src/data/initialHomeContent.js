...
export const initialHomeSections = [
  ...
  },
  {
    ...
    desc: 'Primary campaign banner showcase (Section 1)',
    enabled: true,
    order: 4,
    content: {
      id: 'promo-1',
  ...
  },
  {
    ...
    desc: 'Festive & Celebration Kurta Sets campaign banner (Section 2)',
    enabled: true,
    order: 6,
    content: {
      id: 'promo-2',
  ...
  },
  {
    id: 'promo-banner-3',
    type: 'promo-banner',
    label: 'Promotional Banner 3',
    desc: 'Secondary campaign and festive couture banner (Section 3)',
    enabled: true,
    order: 10,
    content: {
      id: 'promo-3',
