...
export default function Newsletter() {
  ...
  const handleSubmit = (e) => {
    ...
    const message = encodeURIComponent(
      `*JOIN VIP WHATSAPP CLUB - SUKA FASHIONS* 🛍️\n\n` +
      `Hi Suka Fashions! I would like to join the VIP WhatsApp Club for new collection previews, festival offers, and personal styling updates.\n\n` +
  ...
  return (
    <section className="relative py-6 lg:py-8 overflow-hidden" style={{ background: '#004D50' }}>
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 text-center">
        ...
        {subscribed ? (
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-shrink-0 flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-white font-sans text-[10px] font-bold tracking-[0.2em] uppercase py-3.5 px-7 rounded-sm transition-all duration-300 shadow-md disabled:opacity-70 cursor-pointer whitespace-nowrap"
            >
              {loading ? (
        ...
        <p className="font-sans text-[10px] text-brand-powder/40 mt-5 tracking-wide">
          Direct WhatsApp connection • No email spam • Instant VIP access
        </p>
